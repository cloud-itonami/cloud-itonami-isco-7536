...
- safety-critical escalation path (cutting-tool hazard, adhesive-fume
...
- a hard, unconditional block on any attempt to route a
  shoemaking-execution decision, a workshop-safety-clearance decision, or
...
shoemaking-execution decision, a workshop-safety-clearance decision, or a
